...
# 1. 路径设置
CSV_PATH = '/Users/andychan/Documents/GitHub/model-sales-jiuyan/outputs/forecast_results.csv'
...
# 清理旧文件
import glob
for old_file in glob.glob(os.path.join(OUTPUT_DIR, "results-*.xlsx")):
    try:
        os.remove(old_file)
...
NEW_EXCEL_PATH = os.path.join(OUTPUT_DIR, NEW_EXCEL_FILENAME)
...
TAGS_FILE = '/Users/andychan/Documents/GitHub/model-sales-jiuyan/docs/tags.md'
