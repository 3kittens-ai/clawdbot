...
# 0. 配置
EVAL_PATH = '/Users/andychan/Documents/GitHub/model-sales-jiuyan/outputs/backtest_eval.csv'
METRICS_GLOBAL_PATH = '/Users/andychan/Documents/GitHub/model-sales-jiuyan/outputs/metrics_global.csv'
METRICS_HORIZON_PATH = '/Users/andychan/Documents/GitHub/model-sales-jiuyan/outputs/metrics_horizon.csv'
IMPORTANCE_PATH = '/Users/andychan/Documents/GitHub/model-sales-jiuyan/outputs/feature_importance.csv'
DB_PATH = '/Users/andychan/Documents/GitHub/model-sales-jiuyan/data-base/sales_filtered.sqlite'
OUTPUT_DIR = '/Users/andychan/Documents/GitHub/model-sales-jiuyan/outputs/final'
...
# 清理旧文件
import glob
for old_file in glob.glob(os.path.join(OUTPUT_DIR, "db-model-backtest-*.xlsx")):
    try:
        os.remove(old_file)
...
NEW_EXCEL_PATH = os.path.join(OUTPUT_DIR, f'db-model-backtest-{now}.xlsx')
